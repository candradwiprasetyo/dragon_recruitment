...
class Admin_scope_model extends CI_Model{
	...
	function read_id($id)
	{
		...
		$this->db->where('a.scope_id', $id);
		$query = $this->db->get('scopes a', 1); // parameter limit harus 1
	...
	function update($data, $id){
		...
		$this->db->trans_start();
		$this->db->where('scope_id', $id);
		$this->db->update('scopes', $data);
