                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="title_page"> Psycological Test </div>
                             ...
                             <form  class="cmxform" id="createForm" action="" method="post" enctype="multipart/form-data" role="form">
                                       ...
                                       foreach($list as $row): ?>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <div class="radio">
                                                <label>
                                                    <?php
                                                    $answer_is_exist = $this->psychological_test_model->answer_is_exist($data['basic_info_id'], $row_option['question_option_id']);
                                                    ?>
                                                    <input disabled required type="radio" name="i_option_<?= $row['question_id']?>" id="i_option_<?= $row['question_id']?>" value="<?= $row_option['question_option_id']?>"
                                                    <?php

                                                    
                                                    if($answer_is_exist > 0){
                                                    ?>
                                                    checked
                                                    <?php
                                                    }
