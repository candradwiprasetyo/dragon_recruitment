                                        ...
                                        <tbody>
										   ...
										   foreach($list as $row): ?>
                                            <tr>
                                                ...
                                                <td><?= $row['scope_description']?></td>
                                                <td style="text-align:center;">

                                                    <a href="<?= site_url() ?>admin_scope/form/<?= $row['scope_id']?>" class="btn btn-default" ><i class="fa fa-pencil"></i></a>
                                                    <a href="javascript:void(0)" onclick="confirm_delete(<?= $row['scope_id']; ?>, '<?= site_url().'admin_scope/delete/'; ?>')" class="btn btn-default" ><i class="fa fa-trash-o"></i></a>
